    ...
    <div className="min-h-screen relative flex flex-col items-center px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto">
        ...
        >
          ...
          {players.length >= 48 && (
            <p className="text-xs mt-2" style={{ color: "#E53535" }}>
              {t("maxPlayers")}
            </p>
          )}
        </motion.div>
            ...
            {players.map((p, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(245,196,0,0.20), rgba(37,154,90,0.20))",
                    color: "#92740A",
                  }}
                >
                  {i + 1}
        ...
        {/* Start / hint */}
        {players.length === 0 ? (
          <p className="text-center text-sm" style={{ color: "#6C757D" }}>
            {t("minPlayers")}
          </p>
        ) : (
          <motion.div
